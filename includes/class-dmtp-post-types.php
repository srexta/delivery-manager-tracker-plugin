        ...
        public function register_acf_fields() {
            ...
            acf_add_local_field_group(array(
                ...
                'fields' => array(
                    ...
                    array(
                        'key' => 'field_sprint_marketing_tasks',
                        'label' => 'Marketing Tasks',
                        'name' => 'sprint_marketing_tasks',
                        'type' => 'repeater',
                        'instructions' => 'Track marketing tasks and their completion status for this sprint.',
                        'required' => 0,
                        'layout' => 'block',
                        'button_label' => 'Add Marketing Task',
                        'sub_fields' => array(
                            array(
                                'key' => 'field_marketing_task_name',
                                'label' => 'Task Name',
                                'name' => 'marketing_task_name',
                                'type' => 'textarea',
                                'instructions' => 'Describe the marketing task',
                                'required' => 1,
                                'rows' => 3,
                                'wrapper' => array('width' => '50'),
                            ),
                            array(
                                'key' => 'field_marketing_task_status',
                                'label' => 'Task Status',
                                'name' => 'marketing_task_status',
                                'type' => 'true_false',
                                'instructions' => 'Check if task is completed',
                            ...
                            array(
                                'key' => 'field_marketing_verified_by',
                                'label' => 'Verified By Status',
                                'name' => 'marketing_verified_by_status',
                                'type' => 'true_false',
                                'instructions' => 'Check if task has been verified',
                                'message' => 'Verified',
                                'ui' => 1,
                                'ui_on_text' => 'Verified',
                                'ui_off_text' => 'Not Verified',
                                'default_value' => 0,
                                'wrapper' => array('width' => '25'),
                            ),
                        ),
                    ...
                    array(
                        'key' => 'field_sprint_documentation_tasks',
                        'label' => 'Documentation Tasks',
                        'name' => 'sprint_documentation_tasks',
                        'type' => 'repeater',
                        'instructions' => 'Track documentation tasks and their completion status for this sprint.',
                        'required' => 0,
                        'layout' => 'block',
                        'button_label' => 'Add Documentation Task',
                        'sub_fields' => array(
                            array(
                                'key' => 'field_documentation_task_name',
                                'label' => 'Task Name',
                                'name' => 'documentation_task_name',
                                'type' => 'textarea',
                                'instructions' => 'Describe the documentation task',
                                'required' => 1,
                                'rows' => 3,
                                'wrapper' => array('width' => '50'),
                            ),
                            array(
                                'key' => 'field_documentation_task_status',
                                'label' => 'Task Status',
                                'name' => 'documentation_task_status',
                                'type' => 'true_false',
                                'instructions' => 'Check if task is completed',
                                'message' => 'Task Completed',
                                'ui' => 1,
                            ...
                            array(
                                'key' => 'field_documentation_verified_by',
                                'label' => 'Verified By Status',
                                'name' => 'documentation_verified_by_status',
                                'type' => 'true_false',
                                'instructions' => 'Check if task has been verified',
                                'message' => 'Verified',
                                'ui' => 1,
